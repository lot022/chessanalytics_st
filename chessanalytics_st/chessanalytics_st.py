...
class CAST:
    ...
    def WDL_time_control(self, title: str = 'Win/Draw/Loss stats by time control', plot_height: int = 700, plot_hole : float = 0.3):
        ...
        # Update layout to have multiple pie charts
        fig.update_layout(
    ...
    def last_games_stats(self, title : str = 'Last games stats', amount : int = 20, plot_type : str = 'metric_flashy'):
        ...
        # here is tricky sit with 'amount' param. I can make a while loop, but what if some funny guy will put amount being more than total games and
        # it will finish with Stopiteration?  I can iterate firstly thru all games and if amount is more than total games, just return all games or 
        # return amount of games and tell user to change the var to max. And I think leaving it like this is the best option for now. may change in the future tho
        ...
        elif plot_type=='metric_classy':   # hood but classy kaz balagane
...
# borrowed this func from my other project chesstools. feel free to have a look if ur looking for more heatmap/ board visualization related plots
    def heatmap1(self,counter, plot_colorscale='jet', title='Moves heatmap', plot_showscale=False):
        '''
        ...
        fig.update_layout(
            ...
            title=f"{title}",
            xaxis_title=" ",
            yaxis_title=" ",    # for more condensed look, if title is None it doesn't look as god as it should
            width=600,
            height=600
        )
...
# anyway may change in the future tho   
    ...
    def rook_moves(self, plot_colorscale='Viridis', title='Moves heatmap', plot_showscale=True):
        '''
        ...
        cast.heatmap1(rm,plot_colorscale, title, plot_showscale)

    def queen_moves(self,plot_colorscale='Viridis', title='Moves heatmap', plot_showscale=True):
        '''
        ...
        cast.heatmap1(qm,plot_colorscale, title, plot_showscale)

    def bishop_moves(self, plot_colorscale='Viridis', title='Moves heatmap', plot_showscale=True):
        '''
        ...
        cast.heatmap1(bm,plot_colorscale, title, plot_showscale)

    def knight_moves(self, plot_colorscale='Viridis', title='Moves heatmap', plot_showscale=True):
        '''
        ...
        cast.heatmap1(km,plot_colorscale, title, plot_showscale)

    def king_moves(self, plot_colorscale='Viridis', title='Moves heatmap', plot_showscale=True):
        '''
    ...
    def squares_pawn_captures(self, plot_colorscale='Viridis', title='Moves heatmap', plot_showscale=True):
        '''
        ...
        spc = ca.squares_with_Pawncaptures()

        cast.heatmap1(spc,plot_colorscale, title, plot_showscale)

    def squares_knight_captures(self, plot_colorscale='Viridis', title='Moves heatmap', plot_showscale=True):
        '''
        ...
        - plot_showscale (bool): Whether to show the color scale. Default is True.
        '''
        skc = ca.squares_with_Knightcaptures()

        cast.heatmap1(skc,plot_colorscale, title, plot_showscale)

    def squares_bishop_captures(self, plot_colorscale='Viridis', title='Moves heatmap', plot_showscale=True):
        '''
        ...
        sbc = ca.squares_with_Bishopcaptures()

        cast.heatmap1(sbc,plot_colorscale, title, plot_showscale)

    def squares_rook_captures(self, plot_colorscale='Viridis', title='Moves heatmap', plot_showscale=True):
        '''
        ...
        src = ca.squares_with_Rookcaptures()

        cast.heatmap1(src,plot_colorscale, title, plot_showscale)

    def squares_queen_captures(self, plot_colorscale='Viridis', title='Moves heatmap', plot_showscale=True):
        '''
        ...
        sqc = ca.squares_with_Queencaptures()

        cast.heatmap1(sqc,plot_colorscale, title, plot_showscale)
    ...
    def squares_king_captures(self, plot_colorscale='plasma', title='Squares with king captures heatmap', plot_showscale=True, opg=False):
        ...
        skc = ca.squares_with_Kingcaptures(only_player_games=opg)
    ...
    def squares_with_mates(self, plot_colorscale='plasma',title='Squares with checkmates',plot_showscale=True,opg=False):
        ...
        swm = ca.squares_with_mates(only_player_games=opg)

        cast.heatmap1(swm, plot_colorscale, title, plot_showscale)
    ...
    def squares_with_checks(self, plot_colorscale='plasma',title='Squares with checks',plot_showscale=True,opg=False):
        ...
        swc = ca.squares_with_checks(only_player_games=opg)

        cast.heatmap1(swc, plot_colorscale, title, plot_showscale)

    def squares_with_captures(self, plot_colorscale='plasma',title='Squares with captures',plot_showscale=True,opg=False):
        '''
        ...
        swc = ca.squares_with_captures(only_player_games=opg)
...
#cast = CAST('/home/szymek/Downloads/lichess_Yarebore_2024-05-30.pgn', 'Yarebore')
cast = CAST('/home/szymek/Downloads/lichess_PolskaNiemcy2-0_2024-05-31.pgn', 'PolskaNiemcy2-0')
ca = CA('/home/szymek/Downloads/lichess_PolskaNiemcy2-0_2024-05-31.pgn', 'PolskaNiemcy2-0')
#print(cast.bullet_progress_hour())
    ...
    if True:
        ...
        if True:
            ...
            if True:
                ...
                with col1:
                    st.code(f"Game type: 🐇")
                    st.code(f"Game ID: xkOplaSd")
                    st.code(f"Date: 2024.05.31")
                    st.code(f"Time: 15:28:19")
                    st.write('---------------------------------------------------------------------------------------')

                with col2:
                    st.code(f"Black: Player 01")
                    st.code(f"White: Player 02")
                    st.code(f"Result: 🔴 ")
                    st.code(f"White elo: 2190")
                    st.write('---------------------------------------------------------------------------------------')

                with col3:
                    st.code(f"Black elo: 1992")
                    st.code(f"Variant: Chess960")
                    st.code(f"Time control: 120+3")
                    st.code(f"Termination: Time Forfeit")
                    st.write('---------------------------------------------------------------------------------------')
                ...
                with col1:
                    st.code(f"Game type: 🐇")
                    st.code(f"Game ID: 8uA7s0I9")
                    st.code(f"Date: 2024.05.31")
                    st.code(f"Time: 15:56:39")
                    st.write('---------------------------------------------------------------------------------------')

                with col2:
                    st.code(f"Black: Player 02")
                    st.code(f"White: Player 01")
                    st.code(f"Result: 🟢 ")
                    st.code(f"White elo: 2195")
                    st.write('---------------------------------------------------------------------------------------')

                with col3:
                    st.code(f"Black elo: 1988")
                    st.code(f"Variant: Standard")
                    st.code(f"Time control: 120+3")
                    st.code(f"Termination: Normal")
                    st.write('---------------------------------------------------------------------------------------')